...
% Start by seting up the workspace to run the path planning algorithms
clc;clear;close all
...
domain = [0 500; 0, 500; 0, 2*pi]; %domain size, in search coords
